...
namespace lab10
{
    public class Cube
    {
        ...
        //Texture2D texture;
        public Cube(Game1 game, float scale, Vector3 position, String texturePath)//Texture2D texture)
        {
            //this.texture = texture;
            this.game = game;
            this.camera = game.camera;
            Initialize(scale, position, game.Content.Load<Texture2D>(@texturePath));
        }
        public void Initialize(String texturePath)
        {
            Initialize(1, Vector3.Zero, game.Content.Load<Texture2D>(@texturePath));
        }
        public void Initialize(float scaleValue, Vector3 translationValue, Texture2D texture)
        {
