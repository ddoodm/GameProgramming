...
{
    /// <summary>
    /// The system that performs A* Pathfinding on a TowerManager.
    /// 
    /// Unfortunately, as the result of a very busy two weeks,
    /// this class is heavily based upon the article at:
    ...
    class TowerPathFinder
    {
        ...
        public TowerPathFinder(TowerManager map)
        {
            levelHeight = map.blocks.GetLength(0);
            levelWidth = map.blocks.GetLength(1);
