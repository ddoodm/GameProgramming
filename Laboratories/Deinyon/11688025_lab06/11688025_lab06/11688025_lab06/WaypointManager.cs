...
namespace _11688025_lab06
{
    ...
    {
        Game1 game;
        //StaticModel dummy;    // Dummy should now be drawn by the NPC.
        ...
        public void update(GameTime gameTime)
        {
            ...
            kinematic.position = livePosition;

            // Update dummy model
            //dummy.update(gameTime);
            //dummy.world = Matrix.CreateScale(4f) * Matrix.CreateTranslation(kinematic.position);
        }
