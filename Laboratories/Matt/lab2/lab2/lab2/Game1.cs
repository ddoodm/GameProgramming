...
namespace lab2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        SpriteFont font;
        Vector2 fontPos = Vector2.Zero;
        
        const float fontSpeed = 100;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                fontPos.Y -= fontSpeed * (float)gameTime.ElapsedGameTime.TotalSeconds;
                moveInstance.Play();
            }
            ...
            {
                fontPos.X -= fontSpeed * (float)gameTime.ElapsedGameTime.TotalSeconds;
                moveInstance.Play();
            }
